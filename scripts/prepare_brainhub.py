"""Create a BrainHub manifest from explicit local user-provided paths."""
...
from brain_evidence.adapters.brainhub import BrainHubManifest, validate_manifest

_BACKENDS = ("brainhub", "umbrae")
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--backend", choices=_BACKENDS, default="umbrae")
    return parser
